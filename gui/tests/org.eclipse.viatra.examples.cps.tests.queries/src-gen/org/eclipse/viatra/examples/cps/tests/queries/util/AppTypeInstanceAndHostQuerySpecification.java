...
final class AppTypeInstanceAndHostQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "org.eclipse.viatra.examples.cps.tests.queries.appTypeInstanceAndHost";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("app", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.ApplicationType"),new PParameter("appInstance", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.ApplicationInstance"),new PParameter("hostInstance", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.HostInstance"));
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_hostInstance), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://org.eclipse.viatra/model/cps", "HostInstance")));
