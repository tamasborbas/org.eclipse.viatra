...
final class HostCommunicationQuerySpecification extends BaseGeneratedEMFQuerySpecification<ViatraQueryMatcher<IPatternMatch>> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "org.eclipse.viatra.examples.cps.tests.queries.hostCommunication";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("fromHost", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.HostInstance"),new PParameter("toHost", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.HostInstance"));
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_toHost), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://org.eclipse.viatra/model/cps", "HostInstance")));
